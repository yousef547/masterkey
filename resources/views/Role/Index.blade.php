...
@section('page-header')
<a href="{{route('role.create')}}" class="btn btn-info mb-2" title="Create"> <i class="icon-plus"></i> <span>Create</span></a>
@stop
@section('content')
                        ...
                        <table class="table table-striped table-hover dataTable js-exportable" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>2008/11/28</td>
                                    <td>
                                        <a href="{{route('role.update')}}" class="btn btn-success mb-2" title="Edit"><span class="sr-only">Edit</span> <i class="fa fa-edit"></i></a>
